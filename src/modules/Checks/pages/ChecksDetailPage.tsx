  ...
  return (
    <div className="w-full max-w-none bg-[#f6f8fb] pb-12">
      <div className="space-y-5 p-5">
        ...
        <FormCard title="Información del Proyecto" icon="▦" color="#003b5c">
          ...
          {hasObservations && (
            <div className="mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
              <div className="text-sm font-medium text-orange-800">
                ⚠️ Este proyecto tiene observaciones que requieren corrección del Ejecutivo
              </div>
            </div>
          )}
        ...
        {project.validaciones.length > 0 ? (
          <div className="space-y-4">
            ...
            {activeValidation && (
              <FormCard title={`Validación - ${activeValidation.area}`} icon="✓" color="#003b5c">
          ...
          <FormCard title="Validaciones" icon="⊘" color="#003b5c">
